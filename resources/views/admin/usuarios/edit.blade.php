...
@section('content_header')
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <h1 style="margin: 0;">Editar usuario: {{ $usuario->nombre. ' ' .$usuario->apellidos }}</h1>
        <a class="btn btn-secondary btn-sm" href="{{ route('admin.usuarios.index')}}">
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.usuarios.update', $usuario) }}" autocomplete="off"
                enctype="multipart/form-data" file="true">
                @csrf
                @method('PUT') <!-- Establece el método PUT -->

                @include('admin.usuarios.form', $usuario)
