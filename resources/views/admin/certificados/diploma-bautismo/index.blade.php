...
@section('title', 'Certificado de bautismo')

@section('content_header')
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <h1 style="margin: 0;">Diploma de bautismo</h1>
    </div>
@stop
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.diploma.bautismo.download') }}" autocomplete="off" target="_blank">

                @csrf
                @include('admin.certificados.diploma-bautismo.form')
