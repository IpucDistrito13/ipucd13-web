...
@section('title', 'Crear tipo galería')

@section('content_header')
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <h1 style="margin: 0;">Crear tipo galería</h1>
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.galeria_tipos.store') }}" autocomplete="off"
                enctype="multipart/form-data" file="true">

                @csrf

                @include('admin.galeria_tipos.form')

                <div class="modal-footer">
                    <a class="btn btn-secondary" href="{{ route('admin.galeria_tipos.index') }}">Volver</a>
