...
@section('title', 'Editar tipo galería')

@section('content_header')
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <h1 style="margin: 0;">Editar tipo galería: {{ $galeria_type->nombre }}</h1>
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.galeria_types.update', $galeria_type) }}" autocomplete="off"
                enctype="multipart/form-data" file="true">
                @csrf
                @method('PUT') <!-- Establece el método PUT -->

                @include('admin.galeria_types.form', $galeria_type);


                <div class="modal-footer">
                    <a class="btn btn-secondary" href="{{ route('admin.galeria_types.index') }}">Volver</a>
