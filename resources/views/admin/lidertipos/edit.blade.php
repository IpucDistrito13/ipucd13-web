...
@section('content_header')
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <h1 style="margin: 0;">Editar comité: {{ $tipo->nombre }}</h1>
        <div>
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.lideres_tipos.update', $tipo) }}" autocomplete="off"
                enctype="multipart/form-data" file="true">
                @csrf
                @method('PUT') <!-- Establece el método PUT -->

                @include('admin.lidertipos.form', $tipo)
