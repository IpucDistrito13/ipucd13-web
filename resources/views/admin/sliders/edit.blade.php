...
@section('content_header')
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <h1 style="margin: 0;">Editar slider: {{ $slider->titulo }}</h1>
        <a class="btn btn-secondary btn-sm" href="{{ route('admin.sliders.index') }} ">
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.sliders.update', $slider) }}" autocomplete="off"
                enctype="multipart/form-data" file="true">
                @csrf
                @method('PUT')

                @include('admin.sliders.form', $slider)
