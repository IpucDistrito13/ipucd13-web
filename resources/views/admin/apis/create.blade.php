...
@section('title', 'Crear key api')

@section('content_header')
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <h1 style="margin: 0;">Crear key api</h1>
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.keyapis.store') }}" autocomplete="off"
                ...
                <div class="modal-footer">
                    <a class="btn btn-secondary" href="{{ route('admin.keyapis.index') }}">Volver</a>
