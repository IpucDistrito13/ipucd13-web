                    ...
                    <ul class="navbar-nav alt-font">
                        ...
                        <li class="nav-item dropdown dropdown-with-icon">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li><a href="{{ route('public.eventos.index') }}" class="dropdown-item"><i class="bi bi-laptop"></i><div class="submenu-icon-content"><span>Eventos</span></div></a></li>
                                <li><a href="{{ route('public.cronogramas.index') }}" class="dropdown-item"><i class="bi bi-briefcase"></i><div class="submenu-icon-content"><span>Cronograma distrital</span></div></a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown simple-dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink5">
                                @foreach ($comites as $comite)
                                    <li class="dropdown"><a href="{{ route('comite.show', $comite) }}" class="dropdown-item">{{ $comite->nombre }}</a></li>
                                @endforeach
                            </ul>
                        </li>
                        <li class="nav-item dropdown simple-dropdown">
                        ...
                        <li class="nav-item"><a href="{{ route('public.descargables.index') }}" class="nav-link">Descargables</a></li>
                        <li class="nav-item"><a href="{{ route('public.contacto.index') }}" class="nav-link">Contacto</a></li>
