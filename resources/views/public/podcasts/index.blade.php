                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700">Blog metro</h1>
                            ...
                            <li class="grid-item">
                                <figure class="position-relative mb-0 overflow-hidden">
                                    <div class="blog-image bg-dark-slate-blue">
                                        <img src="{{ !empty($podcast->imagen->url) ? Storage::url($podcast->imagen->url) : 'https://via.placeholder.com/1000x1000' }}" alt="" />
