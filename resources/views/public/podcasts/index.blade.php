...
<section class="ipad-top-space-margin bg-dark-gray cover-background page-title-big-typography banner-section"
    style="background-image: url('https://ipucd13.nyc3.cdn.digitaloceanspaces.com/public/banners_internos/podcasts.webp');" >
        ...
        <div class="col-12 mt-4 d-flex justify-content-center">
            <ul class="pagination pagination-style-01 fs-13 fw-500 mb-0">
                ...
                <li class="page-item {{ $podcasts->onFirstPage() ? 'disabled' : '' }}">
                    <a class="page-link" href="{{ $podcasts->previousPageUrl() }}">
                        <i class="feather icon-feather-arrow-left fs-18 d-xs-none"></i>
                    </a>
                </li>

                <!-- Pagination Elements -->
                @foreach ($podcasts->getUrlRange(max(1, $podcasts->currentPage() - 2), min($podcasts->lastPage(), $podcasts->currentPage() + 2)) as $page => $url)
                ...
                <li class="page-item {{ $podcasts->hasMorePages() ? '' : 'disabled' }}">
                    <a class="page-link" href="{{ $podcasts->nextPageUrl() }}">
