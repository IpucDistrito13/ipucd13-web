        ...
        <div class="container">
            <div class="row g-0 justify-content-center">
                ...
                <div class="col-lg-6 col-md-10 offset-xl-2 offset-lg-1 p-6 box-shadow-extra-large border-radius-6px"
                    ...
                    <span class="fs-26 xs-fs-24 alt-font fw-600 text-dark-gray mb-20px d-block">IPUC DISTRITO 13 <br>
                        REGISTRO CONGREGACIÓN</span>
                    <form action="email-templates/contact-form.php" method="post">
                        ...
                        <label class="text-dark-gray mb-10px fw-500">Dirección congregación<span
                                class="text-red">*</span></label>
                        <input class="mb-20px bg-very-light-gray form-control required" type="text" name="direccion"
                            placeholder="Ingresa dirección" />



                        <label class="text-dark-gray mb-10px fw-500">Nombre Congregación<span
                                class="text-red">*</span></label>
                        <input class="mb-20px bg-very-light-gray form-control required" type="text"
                            name="nombre_congregacion" placeholder="IPUC CENTRAL" />

                        <span class="fs-13 lh-22 w-90 lg-w-100 md-w-90 sm-w-100 d-block mb-30px">Your personal data will
                            be used to support your experience throughout this website, to manage access to your
                            account, and for other purposes described in our <a href="#"
                                class="text-dark-gray text-decoration-line-bottom fw-500">privacy policy.</a></span>
                        <input type="hidden" name="redirect" value="">
                        <button
                            class="btn btn-medium btn-round-edge btn-base-color btn-box-shadow submit w-100 text-transform-none"
                ...
                <div class="col-lg-3 col-sm-6 ps-20px sm-ps-15px md-mb-50px xs-mb-0 order-sm-2 order-lg-5">
                    ...
                    <div class="footer-card">
                        <a href="#" class="d-inline-block me-5px align-middle"><img
                                src="https://via.placeholder.com/55x20" alt=""></a>
                        <a href="#" class="d-inline-block me-5px align-middle"><img
                                src="https://via.placeholder.com/55x20" alt=""></a>
                        <a href="#" class="d-inline-block me-5px align-middle"><img
                                src="https://via.placeholder.com/55x20" alt=""></a>
