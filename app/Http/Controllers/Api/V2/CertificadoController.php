...
class CertificadoController extends Controller
{
    ...
    /*
    public function downloadCertificadoBautismoApi(Request $request)
    {
    ...
    */
    ...
    public function downloadCertificadoBautismoApi(Request $request)
    {
        ...
        header('Content-Type: application/pdf');
        header('Content-Disposition: attachment; filename="certificado-bautismo.pdf"');
    
        $pdf->Output('D', 'certificado-bautismo.pdf');
        exit;
    }
